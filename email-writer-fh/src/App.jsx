  ...
  return (
    <div style={{ background: "#0a1f1e", minHeight: "100vh" }}>
      ...
      <section className="lp-hero">
        ...
        <div className="lp-badge"><span className="lp-badge-dot" />AI-Powered Email Replies — Now Live</div>
        <h1 className="lp-title">Write emails <span>10× faster</span><br />with AI</h1>
        <p className="lp-sub">Paste any email, choose your tone, and get a polished reply in seconds. Professional, friendly, or casual — EMIPI handles it all.</p>
        <div className="lp-actions">
          <button className="lp-btn-hero" onClick={() => openModal("signup")}>Start for Free →</button>
          <button className="lp-btn-hero-ghost" onClick={() => openModal("login")}>Sign in</button>
        </div>
        <div className="lp-demo">
          <div className="lp-demo-card">
            <div className="lp-demo-tag">📩 Original Email</div>
            <div className="lp-demo-text">Hi team, just checking in on the Q3 report. Can you send me an update by Thursday? We have a board meeting on Friday and need the latest figures.</div>
            <div className="lp-demo-arrow">↓</div>
            <div className="lp-demo-reply">
              <div className="lp-demo-reply-label">✦ EMIPI Reply · Professional</div>
              <div className="lp-demo-reply-text">Hi [Name], thank you for following up. I'll have the Q3 report ready and sent to you by Thursday morning, ensuring you have ample time to review ahead of Friday's board meeting.</div>
            </div>
          </div>
        </div>
      </section>
